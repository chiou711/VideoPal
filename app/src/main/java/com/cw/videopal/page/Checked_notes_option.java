            ...
            case COPY_CHECKED_NOTE:
                if(!noItemChecked())
                {
                    ...
                    if(option == MOVE_CHECKED_NOTE)
                        operateCheckedTo(mAct,copyItemsTitle, copyItemsPicture, copyItemsDrawing, copyItemsBody, copyItemsTime, MOVE_TO); // move to
                    else if(option == COPY_CHECKED_NOTE)
                        operateCheckedTo(mAct,copyItemsTitle, copyItemsPicture, copyItemsDrawing, copyItemsBody, copyItemsTime, COPY_TO);// copy to
