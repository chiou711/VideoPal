...
package com.cw.videopal.refplayer.queue.ui;
...
import com.cw.videopal.refplayer.queue.QueueDataProvider;
...
public class QueueListAdapter extends MediaQueueRecyclerViewAdapter<QueueListAdapter.QueueItemViewHolder> implements QueueItemTouchHelperCallback.ItemTouchHelperAdapter {
    ...
    public QueueListAdapter(@NonNull MediaQueue mediaQueue, @NonNull Context context, OnStartDragListener dragStartListener) {
        super(mediaQueue);
