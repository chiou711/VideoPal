...
package com.cw.videopal.refplayer.mediaplayer;
...
import com.cw.videopal.refplayer.browser.VideoProvider;
import com.cw.videopal.refplayer.expandedcontrols.ExpandedControlsActivity;
import com.cw.videopal.refplayer.queue.ui.QueueListViewActivity;
import com.cw.videopal.refplayer.settings.CastPreference;
import com.cw.videopal.refplayer.utils.CustomVolleyRequest;
...
//    public static String deviceIpAddress;
    private void setupCastListener() {
        mSessionManagerListener = new SessionManagerListener<CastSession>() {
            ...
            public void onSessionResumed(CastSession session, boolean wasSuspended) {
                System.out.println("--- onSessionResumed");
                onApplicationConnected(session);
            }

            @Override
            public void onSessionResumeFailed(CastSession session, int error) {
                System.out.println("--- onSessionResumeFailed");
                onApplicationDisconnected();
            }
            ...
            public void onSessionStartFailed(CastSession session, int error) {
                System.out.println("--- onSessionStartFailed");
                onApplicationDisconnected();
            }

            @Override
            public void onSessionStarting(CastSession session) {
                System.out.println("--- onSessionStarting");
            }

            @Override
            public void onSessionEnding(CastSession session) {
                System.out.println("--- onSessionEnding");
            }

            @Override
            public void onSessionResuming(CastSession session, String sessionId) {
                System.out.println("--- onSessionResuming");
            }

            @Override
            public void onSessionSuspended(CastSession session, int reason) {
                System.out.println("--- onSessionSuspended");
            }
            ...
            private void onApplicationConnected(CastSession castSession) {
                ...
                if (null != mSelectedMedia) {
                    ...
                    if (mPlaybackState == PlaybackState.PLAYING) {
                        mVideoView.pause();
                        System.out.println("--- onApplicationConnected / mVideoView.pause");
                        loadRemoteMedia(mSeekbar.getProgress(), true);
                        return;
                    } else {
                        mPlaybackState = PlaybackState.IDLE;
                        System.out.println("--- onApplicationConnected / PlaybackState.IDLE");
                        updatePlaybackLocation(PlaybackLocation.REMOTE);
                    }
                }
                updatePlayButton(mPlaybackState);
    ...
    private void loadRemoteMedia(int position, boolean autoPlay) {
        System.out.println("--- loadRemoteMedia / position = " + position + " autoPlay = " + autoPlay);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            mContainer.setBackgroundColor(getResources().getColor(R.color.colorBlack));
            ...
            updateMetadata(true);
            mContainer.setBackgroundColor(getResources().getColor(R.color.colorWhite));
        }
    }
