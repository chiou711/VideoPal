 ...
 */
package com.cw.videopal.refplayer.browser;
...
public class VideoProvider {
    ...
    private static final String TARGET_FORMAT = TAG_HLS; //ori
//    private static final String TARGET_FORMAT = TAG_MP4; ///cw
                    ...
                    for (int j = 0; j < videos.length(); j++) {
                        ...
                        for (int k = 0; k < videoSpecs.length(); k++) {
                            ...
                            if (TARGET_FORMAT.equals(videoSpec.getString(TAG_VIDEO_TYPE))) {
                                ...
                                // local cast test
//                                videoUrl = "content://media/external/video/media/4554";
//                                videoUrl = "content://media/external/video/media/1000000764";
//                                videoUrl = Util.getLocalRealPathByUri(MainAct.mAct, Uri.parse(videoUrl));

//                                  videoUrl = "file:///storage/emulated/0/Movies/LINE/BigBuckBunny.mp4";
//                                videoUrl = "http://"+ VideoBrowserFragment.deviceIpAddress+":8080"+"/"+"Movies/LINE/BigBuckBunny.mp4";
//                                videoUrl = "http://"+ VideoBrowserFragment.deviceIpAddress+":8080"+"/"+"sample.mp4";
//                                videoUrl = "/Movies/LINE/BigBuckBunny.mp4";

//                                videoUrl = "https://drive.google.com/uc?export=download&id=1CP6W_yBo4e_eEUXDMJSCAdE_wIi4o_14";
                                ///
    ...
    public static MediaInfo buildMediaInfo(String title, String studio, String subTitle,
        ...
        return new MediaInfo.Builder(url)
                ...
                .setContentType(mimeType) // ori
//                .setContentType("video/mp4") ///cw
